...
struct FFTDataGenerator
{
    void produceFFTDataForRendering(const juce::AudioBuffer<float>& audioData, const float negativeInfinity)
    {
        ...
        // apply windowing function on data
    ...
    {
        //when changing order, recreate the window, forwardFFT, fifo, fftData
        //reset fifoIndex
...
struct AnalyzerPathGenerator
{
                      ...
                      float negativeInfinity)
    {
        ...
        const int pathResolution = 2; //you can draw line-to's all "pathResolution" pixels
...
struct PathProducer
{
    PathProducer(SingleChannelSampleFifo<KiwisSimpleEQAudioProcessor::BlockType>& scsf) :
...
private:
    SingleChannelSampleFifo<KiwisSimpleEQAudioProcessor::BlockType>* leftChannelFifo;
